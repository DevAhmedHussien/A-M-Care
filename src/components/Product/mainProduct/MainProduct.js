    ...
    return(
        ...
        height:'80vh'}}>
            <Box variant='div' sx={{display:'flex',flexDirection:'column',alignItem:'start'}}>
                <Typography variant='h3' color={colors.primary[200]}>We love this 
                <span style={{color:colors.primary[300]}}> weight loss</span></Typography>
                <Typography variant='h5' color={colors.primary[200]}>The weight is over</Typography>
                <Typography variant='h6' color={colors.primary[200]}>Let’s face it</Typography>
                <ToggleButtons/>
